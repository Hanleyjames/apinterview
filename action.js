...
$(document).ready(function(){
  ...
  testAjaxCallOne()
    ...
    .catch(err => {
      ...
      //the only error should be if the heroku server itself is having an issue on the api side
      console.log(err);
    });
    //Here is an example of just writing the ajax query inside the document
    $.ajax({
      //Set the url to the endpoint
